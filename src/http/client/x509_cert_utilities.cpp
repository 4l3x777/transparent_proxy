...
// Removed this because it drags a ton of additional source in.
// There must be a way to adapt the android functions when the
// time comes to not rely on this monster.
